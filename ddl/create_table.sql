...
CREATE TABLE `employee` (
  ...
  `first_name` varchar(15) DEFAULT NULL COMMENT '名前１',
  `last_name` varchar(15) DEFAULT NULL COMMENT '名前２',
  `first_name_kana` varchar(15) DEFAULT NULL COMMENT 'カナ１',
  `last_name_kane` varchar(15) DEFAULT NULL COMMENT 'カナ２',
  ...
  `status` int DEFAULT NULL,
  `position` int DEFAULT NULL COMMENT '職位',
  `sales_id` varchar(10) DEFAULT NULL COMMENT '営業担当ID',
  `project_end_plan_date` date DEFAULT NULL COMMENT 'プロジェクト予定終了日',
  `delete_falg` int DEFAULT NULL,
  PRIMARY KEY (`emp_id`),
